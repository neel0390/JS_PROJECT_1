...
document.getElementById("btn").addEventListener("click", () => {
  ...
  if (night == "7am" && hrs == 7) {
    dummyText.innerHTML = "Go to Sweet Sleep😴🥱";
    changeImg.src = changeImg.src = "good-night.svg";
    changeImg.setAttribute("height", "100%");
    console.log("7am bro wake up");
